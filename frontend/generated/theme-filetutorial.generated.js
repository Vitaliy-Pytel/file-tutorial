...
import stylesCss from 'themes/filetutorial/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_filetutorial_componentCss']) {
    
    document['_vaadintheme_filetutorial_componentCss'] = true;
  }
